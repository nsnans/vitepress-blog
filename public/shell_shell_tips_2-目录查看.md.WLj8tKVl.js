...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"}},"       # 不能恰当地生成文件时，这个选项会提供帮助。")])])])],-1),B=s("hr",null,null,-1),u=s("blockquote",null,[s("p",null,[s("strong",null,"参数")])],-1),m=s("p",null,"目录：指定要显示列表的目录，也可以是具体的文件。",-1),E=s("hr",null,null,-1);function _(f,b,v,x,I,R){const h=a("Card"),k=a("Collapse");return p(),e("div",null,[d,c,n(h,null,{title:l(()=>[i(" 实例 ")]),default:l(()=>[g]),_:1}),y,n(k,null,{default:l(()=>[F,D,A,C,o,B,u,m]),_:1}),E])}const w=t(r,[["render",_]]);export{N as __pageData,w as default};
