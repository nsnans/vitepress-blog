import{_ as t,e,L as a,k as l,v as s,i,G as n,c as p}from"./chunks/framework.CRIP8SHs.js";const N=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"笔记/shell/shell/tips/2-目录查看.md","filePath":"笔记/shell/shell/tips/2-目录查看.md","lastUpdated":1719890788000}'),r={name:"笔记/shell/shell/tips/2-目录查看.md"},d=s("h3",{id:"目录查看-ls",tabindex:"-1"},[i("目录查看 ls "),s("a",{class:"header-anchor",href:"#目录查看-ls","aria-label":'Permalink to "目录查看 ls"'},"​")],-1),c=s("hr",null,null,-1),g=s("div",{class:"language-sh vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"sh"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"ls"),s("span",{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"}},"       # 仅列出当前目录可见文件")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"   [--color["),s("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"="),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"{none,auto,always}]] [--help] [--version] [--]")])])])],-1),A=s("hr",null,null,-1),C=s("blockquote",null,[s("p",null,[s("strong",null,"选项")])],-1),o=s("div",{class:"language-sh vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"sh"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"-C"),s("span",{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"}},"     # 多列输出，纵向排序。")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"}},"       # 不能恰当地生成文件时，这个选项会提供帮助。")])])])],-1),B=s("hr",null,null,-1),u=s("blockquote",null,[s("p",null,[s("strong",null,"参数")])],-1),m=s("p",null,"目录：指定要显示列表的目录，也可以是具体的文件。",-1),E=s("hr",null,null,-1);function _(f,b,v,x,R,I){const h=n("Card"),k=n("Collapse");return p(),e("div",null,[d,c,a(h,null,{title:l(()=>[i(" 实例 ")]),default:l(()=>[g]),_:1}),y,a(k,null,{default:l(()=>[F,D,A,C,o,B,u,m]),_:1}),E])}const G=t(r,[["render",_]]);export{N as __pageData,G as default};
